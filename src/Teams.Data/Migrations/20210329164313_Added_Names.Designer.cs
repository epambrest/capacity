...
namespace Teams.Data.Migrations
{
    ...
    [Migration("20210329164313_Added_Names")]
    partial class Added_Names
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Teams.Data.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Teams.Data.Models.Team", b =>
                {
                    b.HasOne("Teams.Data.Models.User", "Owner")
                        .WithMany()
            ...
            modelBuilder.Entity("Teams.Data.Models.TeamMember", b =>
                {
                    b.HasOne("Teams.Data.Models.User", "Member")
                        .WithMany()
                        .HasForeignKey("MemberId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
